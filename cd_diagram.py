# wpq: taken from https://github.com/hfawaz/cd-diagram/blob/master/main.py
#
...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=False):
    ...
    plt.ioff()
    fig, ax = graph_ranks(average_ranks.values, average_ranks.keys(), p_values,
    ...
    # wpq: comment this out.
    # plt.savefig('cd-diagram.png',bbox_inches='tight')
    # & return more information than just plotting the plot.
    return {
...
def wilcoxon_holm(alpha=0.05, df_perf=None):
    ...
    """
    import warnings
    # Filter warnings specifically from scipy.stats._wilcoxon
    warnings.filterwarnings("ignore", message="Sample size too small for normal approximation", category=UserWarning, module='scipy.stats._wilcoxon')
